...
public final class AnnotationAwareSignatures {
	...
	public static ClassSignature parseClassSignature(String signature, TypeAnnotationMapping annotationMapping, net.fabricmc.filament.mappingpoet.signature.ClassStaticContext context) {
	...
	public static MethodSignature parseMethodSignature(String signature, TypeAnnotationMapping annotationMapping, net.fabricmc.filament.mappingpoet.signature.ClassStaticContext context) {
	...
	public static TypeName parseFieldSignature(String signature, TypeAnnotationMapping annotationMapping, net.fabricmc.filament.mappingpoet.signature.ClassStaticContext context) {
