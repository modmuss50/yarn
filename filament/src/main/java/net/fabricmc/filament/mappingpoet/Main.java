...
public class Main {
	...
	private static void forEachClass(Path jar, ClassNodeConsumer classNodeConsumer, Path librariesDir) {
		...
		Map<String, NestedClassInfo> nestedClasses = new ConcurrentHashMap<>();
	...
	private static void scanNestedClasses(Map<String, ClassNamePointer> classNames, Map<String, NestedClassInfo> instanceInnerClasses, Path librariesDir) {
		try {
